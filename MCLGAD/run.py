    ...
    for run in range(args.runs):
        ...
        for epoch in range(args.num_epoch):
            ...
            for batch_idx in range(batch_num):
                ...
                logits_2, subgraph_embed, node_embed = model(bf, ba)
                logits_2_hat,  subgraph_embed_hat, node_embed_hat = model(bf, ba_hat)
                ...
                loss = 0.9 * loss_2 + 0.1 * NCE_loss #total loss
        ...
        with tqdm(total=args.auc_test_rounds) as pbar_test:
            ...
            for round in range(args.auc_test_rounds):
                ...
                for batch_idx in range(batch_num):
                    ...
                    with torch.no_grad():
                        test_logits_2, _, _ = model(bf, ba)
                        test_logits_2_hat, _, _ = model(bf, ba_hat)
                        ...
                        ano_score = args.alpha * ano_score_2 + (1 - args.alpha) * ano_score_2_hat
